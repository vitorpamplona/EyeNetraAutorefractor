...
public class YuvFilter {
    ...
    // constructor for Rect bounds
    public YuvFilter(Rect bounds) {
        if (bounds != null) {
            this.Umin = bounds.left;
            this.Umax = bounds.top;
            this.Vmin = bounds.right;
            this.Vmax = bounds.bottom;
    ...
    public boolean isValidPoint(int Uvalue, int Vvalue) {
