...
public class SeekArc extends View {
    ...
    private Paint mDisabledProgressPaint;
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDisabledProgressPaint = new Paint();
        mDisabledProgressPaint.setColor(arcColor);
        mDisabledProgressPaint.setAntiAlias(true);
        mDisabledProgressPaint.setStyle(Paint.Style.STROKE);
        mDisabledProgressPaint.setStrokeWidth(mProgressWidth);

        if (mRoundedEdges) {
            mArcPaint.setStrokeCap(Paint.Cap.ROUND);
            mProgressPaint.setStrokeCap(Paint.Cap.ROUND);
            mDisabledProgressPaint.setStrokeCap(Paint.Cap.ROUND);
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isEnabled())
            ...
            canvas.drawArc(mArcRect, arcStart, mProgressSweep, false, mDisabledProgressPaint);
