...
public abstract class SQLiteModel {
    ...
    public JSONObject toJson() {
        ...
        //id (long) should not get sent to the server

        DataUtil.put(json, Table.SYNC_ID, DataUtil.uuidToString(getSyncId()));

        //TODO: what else: mCreated, mUpdated, mDeleted, mSynced;
        return json;
    }
    ...
    public void updateFromCursor(Cursor c) {
        ...
        //TODO: /TODO: what else: mCreated, mUpdated, mDeleted, mSynced; toSync
    }
