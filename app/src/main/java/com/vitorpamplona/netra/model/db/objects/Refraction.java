...
import com.vitorpamplona.netra.model.db.tables.RefractionTable;
...
public class Refraction extends SQLiteModel {
	...
	*/
    ...
    public boolean hasAnything() {
        return mRightSphere != null || mRightCylinder != null || mRightAxis != null || mRightAdd != null || mRightPd != null
                || mLeftSphere != null || mLeftCylinder != null || mLeftAxis != null || mLeftAdd != null || mLeftPd != null;
    }
    ...
    public boolean isInNeedOfGlasses() {
        boolean right = (mRightSphere == null || mRightCylinder == null) ? false : TheDoctor.isInNeedOfGlassesForDistanceView(mRightSphere.floatValue(), mRightCylinder.floatValue());
        boolean left = (mLeftSphere == null || mLeftCylinder == null) ? false : TheDoctor.isInNeedOfGlassesForDistanceView(mLeftSphere.floatValue(), mLeftCylinder.floatValue());
